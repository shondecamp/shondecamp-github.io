...
td {
    ...
    <body>
        ...
        <div class="title">
            <a>TL_PC_REN<button class="tinybutton" style="position:relative;top:0px;" "window.location.href = 'https://shondecamp.github.io/shondecamp-github.io/';"><img src="Edit.png">Edit Fee Schedule</button></a>
        </div>
        <div class="meta">
            <div class="subtitle">
